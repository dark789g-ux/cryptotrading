...
const columnDefs = computed(() => createASharesIndexColumnDefs())
...
// 本面板懒挂在 ASharesTabsContainer（n-tabs show:lazy）的 index pane 内，且整个容器位于
// SymbolsView 顶层 <keep-alive>。首挂载时 onActivated 不触发（激活时机已过）→ 首屏用 onMounted；
