...
export const FIELD_DESCRIPTIONS: Record<string, string> = {
  ...
  obv5d: '成交额 OBV5D：最近 5 个交易日「涨加成交额、跌减成交额」的滚动累计，单位千元。严格模式：序列不足 5 根为空。',
  obv10d: '成交额 OBV10D：最近 10 个交易日「涨加成交额、跌减成交额」的滚动累计，单位千元。',
  obv20d: '成交额 OBV20D：最近 20 个交易日「涨加成交额、跌减成交额」的滚动累计，单位千元。',
