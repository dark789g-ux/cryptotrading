...
/**
 * ETF 资金净流入，同构 money_flow_industries。
 * 由 ETF 成分股 money_flow_stocks 聚合而来。
 */
@Entity('money_flow_etf')
@Unique(['tsCode', 'tradeDate'])
@Index('idx_money_flow_etf_code_date', ['tsCode', 'tradeDate'])
@Index('idx_money_flow_etf_date', ['tradeDate'])
export class MoneyFlowEtfEntity {
