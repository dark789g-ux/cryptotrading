# =====================================================================
# 20260616140000-us-index-run-type-check.ps1
#
...
$scriptPath = Join-Path $PSScriptRoot "20260616140000-us-index-run-type-check.sql"

if (-not (Test-Path $scriptPath)) {
  throw "SQL 文件不存在：$scriptPath"
}

Write-Host "执行 ml_jobs_run_type_check 加入 us_sync/us_index_sync migration..."
...
Write-Host ""
Write-Host "==== 校验：约束现含 us_sync / us_index_sync ===="
