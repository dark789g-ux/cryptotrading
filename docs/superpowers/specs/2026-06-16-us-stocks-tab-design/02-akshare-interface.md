...
- **`SPCX`**：实测窗口内仅 **1 行**，但这是 **真 SpaceX**——2026-06-12 Nasdaq IPO（收 $160.95，与库存行一致），窗口末日 `20260612` 恰为其 IPO 日，故只有 1 行属**正常**、非异常、非 failed_item。end_date 推到更近日期重灌即补后续交易日。（注：早期凭"SpaceX 未上市"误判为退市/SPAC 残值，系未核实其已上市，已订正。）
